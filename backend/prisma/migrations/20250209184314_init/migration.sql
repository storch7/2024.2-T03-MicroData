/*
  ...
  - Added the required column `ativo` to the `LimitesContagem` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "LimitesContagem" ADD COLUMN     "ativo" BOOLEAN NOT NULL,
